...
function Home() {
    ...
    return (
		...
		<button style={{borderRadius: "5px"}}onClick={handleDownload}> <strong>Get Product List</strong></button>
	  </div>
        {message && (
            ...
            {data.map((dataObj, index) => (
                <div className="product-card" style={{ width: '25%' }}>
                    ...
                    <div className="product-details">
                        <span className="product-catagory"><strong>{dataObj.name}</strong></span>
                        <h4>
                            <a href=""><strong>{dataObj.name}</strong></a>
                        </h4>
                        <p><strong> {dataObj.description}</strong>
                        ...
                        <div className="product-bottom-details">
                            ...
                            <button onClick={() => addToCart(dataObj.id, dataObj.price)}> <strong>Add to cart</strong></button>
                            </div>
                        </div>
                    </div>
                </div>
